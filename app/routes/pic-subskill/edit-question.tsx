...
export async function loader({ request, params, context }: Route.LoaderArgs) {
  const subskill = await SubskillService.getSubskillByIdWithSkill(
    params.idSubSkill,
  );

  const { question, options } = await ManageKuisService.getQuestionDataByIdKuis(
    params.idKuisQuestion,
  );
    ...
    <div>
      ...
      <FormMakeKuis
        defaultValues={{
          ...
          answerOption: question.answerOption as "a" | "b" | "c" | "d",
          // options: {
          ...
          waktuPengerjaanDetik: Number(question.waktuPengerjaanDetik) ?? 15,
        }}

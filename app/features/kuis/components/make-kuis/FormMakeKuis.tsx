  ...
  return (
    ...
    >
      <FieldSet>
        <FieldGroup>
          <Field>
            <FieldLabel htmlFor="soal">Soal</FieldLabel>

            <Textarea
              {...getTextareaProps(fields.question)}
              placeholder="Masukkan soal"
            />
            <FieldError id={fields.question.id}>
              {fields.question.errors}
            </FieldError>
          </Field>
          <Field>
            <FieldLabel>Pilihan ganda</FieldLabel>
            {optionChar.map((o, i) => (
          ...
          <Field className="w-1/2">
            ...
            />
            <FieldError id={fields.answerOption.id}>
              {fields.answerOption.errors}
            </FieldError>
          </Field>
          <Field className="w-1/2">
            <FieldLabel>Waktu Pengerjaan (detik)</FieldLabel>
            <Input
              {...getInputProps(fields.waktuPengerjaanDetik, {
                type: "number",
              })}
              defaultValue={fields.waktuPengerjaanDetik.defaultValue}
              placeholder="Waktu pengerjaan"
            />
            <FieldError id={fields.waktuPengerjaanDetik.id}>
              {fields.waktuPengerjaanDetik.errors}
            </FieldError>
          </Field>

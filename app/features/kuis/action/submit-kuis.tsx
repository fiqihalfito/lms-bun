...
export async function loader({ request, params, context }: Route.LoaderArgs) {
  // const jawabanUserData = await getKuisJawabanUserByIdKuisProgress(
  ...
  // });
  //
  await PengerjaanKuisService.submitKuis(params.idKuisProgress);

  return replace(
    `/app/kuis/${params.idKuis}/progress/${params.idKuisProgress}/finish`,
  );

...
import { DatabaseIcon, PyramidIcon } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-400 text-sm flex items-center gap-2">
                ...
                {skillProgressDetail.jumlahUpload} dari{" "}
                {skillProgressDetail.jumlahSubkill} dokumen subskill terupload
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="flex flex-col justify-center items-center p-6 border-2 border-primary/10 shadow-sm relative overflow-hidden">
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-sm text-foreground font-medium">
            {skillProgressDetail.jumlahUpload}{" "}
            <span className="text-muted-foreground font-normal">of</span>{" "}
            {skillProgressDetail.jumlahSubkill} Documents
          </p>
        </div>
      </Card>
    </div>

...
type SubskillStatPerLevelProps = {
  subskillStatPerLevel: Awaited<
    ReturnType<typeof SubskillService.getSubskillStatPerLevel>
  >;
};

export function SubskillStatPerLevel({
  subskillStatPerLevel,
}: SubskillStatPerLevelProps) {
  const {
    jumlahSudahBaca,
    jumlahSudahKuis,
  ...
  return (
    <div className="border p-4 rounded-md mb-8  shadow-sm">
      ...
      <div className="flex items-center gap-x-8 mb-4">
        ...
        <div className="text-7xl font-semibold font-mono text-slate-600">
          {persentaseProgress}%
        </div>
      </div>
        ...
        <div className="border rounded-md p-4 flex items-center gap-x-6 shadow">
          ...
          <div className="">
            ...
            <div className="text-3xl font-semibold font-mono text-muted-foreground">
              {jumlahSudahBaca} / {jumlahSubskillPerLevel}
            </div>
          </div>
        </div>
        <div className="border rounded-md p-4 flex items-center gap-x-6 shadow">
          ...
          <div className="">
            ...
            <div className="text-3xl font-semibold font-mono text-muted-foreground">
              {jumlahSudahKuis} / {jumlahSubskillPerLevel}
            </div>
          </div>
        </div>
      </div>

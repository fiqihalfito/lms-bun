...
export const picSubSkillColumns: ColumnDef<
  Awaited<
    ReturnType<typeof SubskillService.getSubSkillByIdPIC>
  >[number]["subskills"][number]
>[] = [
  {
    id: "nomor",
    header: "No",
      ...
      return idKuis ? (
        <div className="flex flex-row gap-x-1">
          ...
          {row.original.kuis?.questions && (
            <Badge
              variant={
                row.original.kuis.questions.length > 0 ? "default" : "warning"
              }
            >
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-end gap-x-1">
        ...
        <UploadDokumenDirectButton
          idSubSkill={row.original.idSubSkill}
          namaSubSkill={row.original.namaSubSkill}
          idDokumen={row.original.idDokumen}
        />

...
export async function getUserSkillIndicator(idUser: string) {
    ...
    const data = user_x_subskill_lulus_baca;

    const skillGroup = R.groupBy(data, (item) => item.namaSkill ?? "other_skill");
